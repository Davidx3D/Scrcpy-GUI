...
public class gui extends javax.swing.JFrame {
  ...
  try {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Scrcpy-GUI v1.1");
  ...
  if (Off) {
	...
	try {
	 ...
	 if (Terminal.exists()){
			 ...
			 try {
				 ...
				 String[] cmdArray = {"xterm", "-e", "scrcpy" + mods +" ; le_exec"};//Opens Terminal And Run Scrcpy On Linux
   ...
   }	else { Process p = Runtime.getRuntime().exec("cmd.exe /c scrcpy " + mods); //Opens Cmd And Runs Scrcpy With Added Scripts
